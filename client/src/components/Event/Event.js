    ...
    return (
        <div className="row" style= {{marginTop: "200px", marginLeft:"200px"}}>
            ...
            <div>
                ...
                {new Date(event.Enddate)>new Date()&&(<Button onClick={handleOpen} style={{marginLeft: "242px", marginTop: "-77px"}}>Add more</Button>)}
      ...
      >
        ...
        <Col>
        <lebel>Anonyme</lebel>
        <Checkbox value={anonyme} onChange={()=>{
          setAnonyme(!anonyme)
          console.log(anonyme)
        }} /></Col>
        <button onClick={()=>{
      ...
      <CardHeader
        avatar={
          <Avatar sx={{ bgcolor: red[500] }} aria-label="recipe">
           { donation.anonyme?"A":<img src={donation.user?.profile_picture}/>}
          </Avatar>
        }
         
        title={donation.anonyme?"Anonyme":donation.user?.username}
