...
function WishListArea() {
  ...
  const RemoveFromWishList = async (prodId,userId) =>{
    
     await axios.put(`http://127.0.0.1:5000/products/wishListDel/${prodId}/${userId}`)
                ...
                userInfo.map((product) => 
                  <tr>
                    <td className="product-remove">
                      <a   className="remove" onClick={()=>{RemoveFromWishList(product._id,idUser)}} >
